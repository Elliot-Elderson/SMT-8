...
- 状态空间总数：122880
- V_explicit（显式覆盖，策略表达力）：121436（98.82%）
...
- 同级保护不对称数：62
  ...
  - 高={'operation': 'read', 'resource_class': 'agent_memory', 'target_zone': 'local', 'flags': ['taint_credential', 'taint_session_data']} D=1 vs 低={'operation': 'read', 'resource_class': 'agent_private_context', 'target_zone': 'local', 'flags': ['taint_credential', 'taint_session_data']} D=2
